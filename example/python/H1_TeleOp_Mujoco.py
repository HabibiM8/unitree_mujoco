...
#Import Stuff for Teleoperation
import numpy as np
import time
import argparse
import cv2
...
current_dir = os.path.dirname(os.path.abspath(__file__))        # "example/python"
...
def runner():
    ...
    if args.hand == "dex3":
        ...
        hand_ctrl = Dex3_1_Controller(left_hand_array, right_hand_array, dual_hand_data_lock, dual_hand_state_array,
        ...
        gripper_ctrl = Gripper_Controller(left_hand_array, right_hand_array, dual_gripper_data_lock,
